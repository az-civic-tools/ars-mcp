...
#
# Usage:
#   1. Visit https://github.com/az-civic-tools/ars-mcp/wiki
...
WIKI_REPO_URL="https://github.com/az-civic-tools/ars-mcp.wiki.git"
TMPDIR=$(mktemp -d)
...
if ! git clone "$WIKI_REPO_URL" "$TMPDIR/wiki"; then
  ...
  echo "Visit https://github.com/az-civic-tools/ars-mcp/wiki and click 'Create the first page'."
...
echo
echo "Wiki updated: https://github.com/az-civic-tools/ars-mcp/wiki"
